...
## Neat 1.8.0 for GetBuffaloWater

This project is a clone of [Neat 1.8.0](https://github.com/thoughtbot/neat/tree/v1.8.0) which removes some broken dependencies found in the official 1.8.0 release of Neat, namely preventing the 404 error that **node-sass@3.13.1** is not available at the download below.

```
npm install bourbon-neat@1.8.0

> node-sass@3.13.1 install C:\Users\mbrown\Documents\GitHub\affordable_water\node_modules\bourbon-neat\node_modules\node-sass
...
### The following is Neat's original documentation.
---
